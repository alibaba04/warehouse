                ...
                <div class="box-body">
                    <table class="table table-bordered table-striped table-hover" >
                        <thead>
                            <tr>
                                <th style="width: 3%">#</th>
                                <th width="20%" class="sort-alpha">Code </th>
                                <th width="30%" class="sort-alpha">Menu Name</th>
                                <th width="30%">Link</th>
                        ...
                        <tbody>
                            ...
                            if ((int)$resultpage>1){
                                $rowCounter = ((int)$resultpage * 10) - 10 + $rowCounter; //per halaman 10 list
                            }
                            ...
                            while ($query_data = $rs->fetchArray()) {
                                ...
                                if ($hakUser == 90) {
                                    echo "<td><span class='label label-success' style='cursor:pointer;' onclick=location.href='" . $_SERVER['PHP_SELF'] . "?page=view/menu_detail&mode=edit&kode=" . md5($query_data[0]) . "'><i class='fa fa-edit'></i>&nbsp;Edit</span></td>";
                                    echo("<td><span class='label label-danger' onclick=\"if(confirm('Apakah anda yakin akan menghapus data Menu " . $query_data[1] . " ?')){location.href='index2.php?page=" . $curPage . "&txtMode=Delete&kodeUser=" . md5($query_data[0]) . "'}\" style='cursor:pointer;'><i class='fa fa-trash'></i>&nbsp;Delete</span></td>");
