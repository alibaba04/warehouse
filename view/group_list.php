                ...
                <div class="box-body">
                    <table class="table table-bordered table-striped table-hover" >
                        <thead>
                            <tr>
                                <th style="width: 3%">#</th>
                                <th width="30%" class="sort-alpha">Group Code</th>
                                <th width="50%" class="sort-alpha">Group Name</th>
                        ...
                        <tbody>
                            ...
                            while ($query_data = $rs->fetchArray()) {
                                ...
                                if ($hakUser == 90) {
                                    echo "<td><span class='label label-success' style='cursor:pointer;' onclick=location.href='" . $_SERVER['PHP_SELF'] . "?page=view/group_detail&mode=edit&kode=" . md5($query_data["kodeGroup"]) . "'><i class='fa fa-edit'></i>&nbsp;Edit</span> ";
                                    
                                    echo("<span class='label label-danger' onclick=\"if(confirm('Apakah anda yakin akan menghapus data Group " . $query_data["nama"] . " ?')){location.href='index2.php?page=" . $curPage . "&txtMode=Delete&kodeGroup=" . md5($query_data["kodeGroup"]) . "'}\" style='cursor:pointer;'><i class='fa fa-trash'></i>&nbsp;Delete</span></td>");
