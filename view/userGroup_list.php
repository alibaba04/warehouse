    ...
    <div class="row">
        ...
        <section class="col-lg-12 connectedSortable">
            <div class="box box-primary">
                ...
                $q.= "FROM aki_usergroup g, aki_groups gp, aki_user u ";
                ...
                <div class="box-body">
                    <table class="table table-bordered table-striped table-hover" >
                        <thead>
                            <tr>
                                <th style="width: 3%">#</th>
                                <th width="20%" class="sort-alpha">Group Name</th>
                        ...
                        <tbody>
                            ...
                            while ($query_data = $rs->fetchArray()) {
                                ...
                                if ($hakUser == 90) {
                                    echo "<td><span class='label label-success' style='cursor:pointer;' onclick=location.href='" . $_SERVER['PHP_SELF'] . "?page=view/userGroup_detail&mode=edit&kode=" . md5($query_data[0]) . "'><i class='fa fa-edit'></i>&nbsp;Edit</span></td>";
                                    echo("<td><span class='label label-danger' onclick=\"if(confirm('Apakah anda yakin akan menghapus data?')){location.href='index2.php?page=" . $curPage . "&txtMode=Delete&kodeUserGroup=" . md5($query_data[0]) . "'}\" style='cursor:pointer;'><i class='fa fa-trash'></i>&nbsp;Delete</span></td>");
