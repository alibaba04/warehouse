<?php
    ...
    $pdf->Cell(0, 5, "Laporan Transaksi Barang Keluar : ".$tgl[0].' sampai '.$tgl[1], 0, 1, 'C');
    ...
    //database
    $q2 = "SELECT b.kode,b.nama,cust,kodeproyek,bk.nobkeluar as no,qty,tgl_bkeluar as tgl,'out' as ket FROM `aki_barang` b RIGHT join aki_dbkeluar dbk on b.kode=dbk.kode_barang RIGHT join aki_bkeluar bk on bk.nobkeluar=dbk.nobkeluar where tgl_bkeluar BETWEEN '".$tgl1."' and '".$tgl2."'";
    ...
    //output file PDF
    $pdf->Output('TransaksiOut.pdf', 'I'); //download file pdf
?>